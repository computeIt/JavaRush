...
public class Solution {
    ...
    public static class Cat {
        @JsonProperty(value = "wildAnimal")//назначаем, каким будет имя поля после сериализации
        public String name;
        @JsonIgnore                       //указываем необходимость игнорирования поля при конвертации в json. кстати, если аннотацию не ставить вообще, то результат не изменится
        public int age;
        @JsonProperty(value = "over")     //назначаем, каким 
        public int weight;
