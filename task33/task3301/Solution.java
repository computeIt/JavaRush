//к сериализуемым классам необходимо добавить аннотацию @JsonAutoDetect
//чтобы все данные классов были сериализуемыми, необходимо, чтобы они(данные) были либо public, либо имели getters-setters
